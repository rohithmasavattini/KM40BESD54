...
------------------------------------------------------
- 3.1-hello/hello.c:
	how to write template of Module programming
- 3.2-modparam/modparam1.c,modparam2.c:   
	Module parameter usage.
- 3.3-moddep/add.c,avg.c: 
	What is Module Dependency? How to overcome? What is modprobe? How it works?
- 3.4-mulmod/start.c,stop.c: 
	how to compile multiple modules.
